...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow border-top border-5 border-primary sticky-top p-0">
        <a href="index.jsp" class="navbar-brand bg-primary d-flex align-items-center px-4 px-lg-5">
            <h2 class="mb-2 text-white">AE SHIPPING</h2>
        </a>
        ...
        <div class="container about py-5 px-lg-0">
            <div class="row g-5 mx-lg-0">
                ...
                <div class="col-lg-6 about-text wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-5">At AE Shipping Co., we pride ourselves on being a leading provider of comprehensive logistics solutions since 1990. With a commitment to excellence, we specialize in delivering seamless shipping experiences globally, ensuring reliability, efficiency, and customer satisfaction. Our dedicated team and state-of-the-art technology empower us to meet the diverse needs of our clients, offering tailored solutions that optimize supply chain management and exceed expectations. Whether it's air, ocean, road, or rail freight, coupled with expert customs clearance and warehousing services, we are here to streamline your logistics processes and drive your business forward.</p>
                    ...
                    <a href="services.jsp" class="btn btn-primary py-3 px-5">Explore More</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="service.jsp">Air Freight</a>
                    <a class="btn btn-link" href="service.jsp">Sea Freight</a>
                    <a class="btn btn-link" href="service.jsp">Road Freight</a>
                    <a class="btn btn-link" href="service.jsp">Logistic Solutions</a>
                    <a class="btn btn-link" href="service.jsp">Industry solutions</a>
                </div>
                <div class="col-lg-3 col-md-6">
